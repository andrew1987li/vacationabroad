...
public partial class ViewProperty : CommonPage
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (PropertiesFullSet.Tables["Properties"].Rows.Count < 1)
            ...
            description.Content = Description.Text.Replace("%city%", PropertiesFullSet.Tables["Properties"].Rows[0]["City"].ToString()).
                Replace("%bedroom%", PropertiesFullSet.Tables["Properties"].Rows[0]["NumBedrooms"].ToString()).
                    Replace("%stateprovince%", PropertiesFullSet.Tables["Properties"].Rows[0]["StateProvince"].ToString()).
                    Replace("%country%", PropertiesFullSet.Tables["Properties"].Rows[0]["Country"].ToString()).
                    Replace("%region%", PropertiesFullSet.Tables["Properties"].Rows[0]["Region"].ToString()).
...
Replace("%name%", PropertiesFullSet.Tables["Properties"].Rows[0]["Name"].ToString()).
                    Replace("%numbedrooms%", PropertiesFullSet.Tables["Properties"].Rows[0]["NumBedrooms"].ToString()).
                    Replace("%numsleeps%", PropertiesFullSet.Tables["Properties"].Rows[0]["NumSleeps"].ToString()).Replace("%propid%", propertyid.ToString());
    ...
    private void InitializeComponent()
    {
        ...
        // sqlSelectCommand1
        // 
        this.sqlSelectCommand1.CommandText = "SELECT MinimumNightlyRentalTypes.Name AS MinimumNightlyRental, " +
    ...
    protected void SubmitButton_Click(object sender, System.EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
           string emailtoowner = "";
            ...
            string details = "";
            String nowip = Request.ServerVariables["REMOTE_ADDR"].ToString();
            
            string originatingCity = CommonFunctions.GetSiteAddress() +
            ...
            string vSubject = originatingCity +
                ((int)PropertiesFullSet.Tables["Properties"].Rows[0]["ID"]).ToString() + "/default.aspx";

            if (IfShowContactInfo())
            {
                details = "Inquiry data:<br />";
                details += "Arrival date: " + ArrivalDay.Items[ArrivalDay.SelectedIndex].Value + " " +
                   ArrivalMonth.Items[ArrivalMonth.SelectedIndex].Value + " " + ArrivalYear.Items[ArrivalYear.SelectedIndex].Value + " " + "<br />";
                ...
                string vSub1 = "Your property \"" + (string)PropertiesFullSet.Tables["Properties"].Rows[0]["Name"] + "\" (" +
                    ...
                    "Has been inquired about by IP Address: " + nowip + "<br />" + ContactName.Text + " (" + ContactEmail.Text;
            ...
            // EmailsSet apparently throws a copy of this email info into an area the own can see later.  related to ViewEmails.aspx.  Very poorly done, IMHO --LMG
            ...
            emailtosender = emailtosender + "<br/><span style=\"font-size:12px\">Linda K. Jenkins</span><br/><span style=\"font-size:10px\">CEO Vacations-Abroad.com<br/>Atlanta, GA<br/>770-687-6889</span> <br/><img align=\"middle\" style=\"height:202px;width:223px;border-width:0px;left:34px\" src=\"http://www.vacations-abroad.com/largelogo.jpg\"/>" +
            "<span style=\"font-style:italic\">Where you can find unique vacation rentals, boutique hotels, and quaint B&Bs.</span>";
            ...
            message.From = new MailAddress(ContactEmail.Text);
            ...
            //TO SENDER
            if (ContactEmail.Text.Trim() != "")
            {
                try
                {
                    MailMessage message2 = new MailMessage("prop@" + CommonFunctions.GetDomainName(), ContactEmail.Text);
            ...
            {
                MailMessage message2 = new MailMessage(ContactEmail.Text , System.Configuration.ConfigurationManager.AppSettings["InquiryEmail"]);
                ...
                message2.IsBodyHtml = message.IsBodyHtml;
                //message2.Headers["Content-Type"] = message.Headers["Content-Type"];
                message2.From = new MailAddress(ContactEmail.Text);
            ...
            {
                MailMessage message2 = new MailMessage(ContactEmail.Text, System.Configuration.ConfigurationManager.AppSettings["InquiryEmail2"]);
            ...
            lblMsg.Text = "<br/>Email inquiry sent successfully.";
            ContactEmail.Text = "";
            Comments.Text = "";
            HowManyChildren.Text = "";
            HowManyAdults.Text = "";
            HowManyNights.Text = "";
            ArrivalMonth.SelectedIndex = 0;
            ArrivalDay.SelectedIndex = 0;
            ContactTelephone.Text = "";
            ContactName.Text = "";
            Response.Redirect("ThankYouInquiry.aspx?redirect=" + (originatingCity + "default.aspx"));
