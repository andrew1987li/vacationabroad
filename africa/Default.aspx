...
<asp:Content ID="Content" ContentPlaceHolderID="Content" runat="Server">
    ...
    <div class="upperheader" style="width: 68.8%">
        <h1>Vacation Rentals in Africa</h1></br>
    </div>
    <%--Main div--%>
    <div>
        <div>
                ...
                <div style="border: solid 0px #ececec; padding: 2px; background-color: white;width:928px">
                    <div id="ctl00_TabContainer_divAfrica">
                        <ul class="TripleListMain">
                            ...
                            <li style="width:16%"><a class="mainPgCountry" href="http://www.vacations-abroad.com/egypt/default.aspx"><b>Egypt</b></a></li>
                            <li style="width:16%"><a class="mainPgCountry" href="http://www.vacations-abroad.com/kenya/default.aspx"><b>Kenya</b></a></li>
                            <li style="width:16%"><a class="mainPgCountry" href="http://www.vacations-abroad.com/mauritius/default.aspx"><b>Mauritius</b></a></li>
                            <li style="width:16%"><a class="mainPgCountry" href="http://www.vacations-abroad.com/morocco/default.aspx"><b>Morocco</b></a></li>
                            <li style="width:16%"><a class="mainPgCountry" href="http://www.vacations-abroad.com/south_africa/default.aspx"><b>South Africa</b></a></li>
                            <li style="width:16%"><a class="mainPgCountry" href="http://www.vacations-abroad.com/tunisia/default.aspx"><b>Tunisia</b></a></li>
        ...
        <div class="greytext" style="background-color: white">
            ...
            <div style="border: solid 0px #ececec; padding: 2px; background-color: white; text-align: center; width: 918px;">
                ...
                <div style="float: left; width: 365px;">
                    <h3><a class="mainPgCountry" href="http://www.vacations-abroad.com/south_africa/mpumalanga/kruger_national_park/default.aspx"><b>Kruger National Park South Africa</b></a></h3>
                </div>
                <div style="float: left; width: 250px;">
                    <h3><a class="mainPgCountry" href="http://www.vacations-abroad.com/south_africa/limpopo/hoedspruit/default.aspx"><b>Hoedspruit South Africa</b></a></h3>
                </div>
                <div style="float: left; width: 250px;">
                    <h3><a class="mainPgCountry" href="http://www.vacations-abroad.com/south_africa/cape_province/addo/default.aspx"><b>Addo South Africa </b></a></h3>
                </div>
            ...
            <div class="greytext">
                <div style="border: solid 0px #ececec; padding: 2px; background-color: white; text-align: center; width: 800px">
                    ...
                    <div style="float: left; width: 413px;">
                        <h3><a class="mainPgCountry" href="http://www.vacations-abroad.com/kenya/coast/diani_beach/default.aspx"><b>Diani Beach Kenya</b></a></h3>
                    </div>
                    <div>
                        <h3><a class="mainPgCountry" href="http://www.vacations-abroad.com/egypt/janub_sina/dahab/default.aspx"><b>Dahab Egypt</b></a></h3>
                    </div>
                    <div style="float: left; width: 413px;">
                        <h3><a class="mainPgCountry" href="http://www.vacations-abroad.com/south_africa/cape_province/camps_bay/default.aspx"><b>Camps Bay South Africa</b></a></h3>
                    </div>
                    <div>
                        <h3><a class="mainPgCountry" href="http://www.vacations-abroad.com/south_africa/cape_province/natures_valley/default.aspx"><b>Natures Valley South Africa</b></a></h3>
                    </div>
            ...
            <div class="greytext" style="background-color: white">
                ...
                <div style="border: solid 0px #ececec; padding: 2px; background-color: white; text-align: center; width: 918px;">
                    ...
                    <div style="float: left; width: 33%;">
                        <h3><a class="mainPgCountry" href="http://www.vacations-abroad.com/south_africa/gauteng/johannesburg/default.aspx"><b>Johannesburg South Africa</b></a></h3>
                    </div>
                    <div style="float: left; width: 33%;">
                        <h3><a class="mainPgCountry" href="http://www.vacations-abroad.com/south_africa/cape_province/cape_town/default.aspx"><b>Cape Town South Africa</b></a></h3>
                    </div>
                    <div style="float: left; width: 33%;">
                        <h3><a class="mainPgCountry" href="http://www.vacations-abroad.com/morocco/marrakech/marrakech/default.aspx"><b>Marrakech Morocco</b></a></h3>
                    </div>
