...
<asp:Content ID="Content" ContentPlaceHolderID="Content" runat="Server">
    ...
    <div class="upperheader" style="width: 68.8%">
        <h1>Oceania Vacations, Oceania Beach Vacations, Oceania Destinations</h1>
    </div>
    <%--Main div--%>
    <div>
        <div>
    ...
    fjs.parentNode.insertBefore(js, fjs);
            ...
            <div class="greytext" style="background-color: white;">
                ...
                <%--<p>Work-weary vacationers, fun-seeking families, or solitary explorers—Oceania vacations offer something for every intent and purpose. Plenty of flowers bloom as the sun shines across these exotic destinations. Waterfalls surrounded by thickets of orchids plunge into ponds hidden amidst flowers and trees. Soft white sands carpet the shallow sea basins and turquoise lagoons where you can swim amidst shoals of fish and behold exquisite coral gardens. The cruises, the fishing trips, the heart-warming weather, and the friendliest people inhabiting these islands make Oceania vacations the romance of a lifetime. </p>--%>
