...
<%@ Page Language="C#" MasterPageFile="~/MasterPageNoCss.master" AutoEventWireup="true"
    CodeFile="Locations2.aspx.cs" Inherits="Locations" Title="Locations Administration" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="Content" runat="Server">
                    ...
                    <tr>
                        ...
                        <td colspan="3" align="right">
                            <a href='<%= CommonFunctions.PrepareURL ("InvoiceRegister.aspx?Year=2004", "Administration") %>'>
                                Invoice Register 2004 </a>&nbsp;&nbsp; <a href='<%= CommonFunctions.PrepareURL ("InvoiceRegister.aspx?Year=2005", "Administration") %>'>
                                    Invoice Register 2005 </a>&nbsp;&nbsp; <a href='<%= CommonFunctions.PrepareURL ("InvoiceRegister.aspx?Year=2006", "Administration") %>'>
                                        Invoice Register 2006 </a>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table width="100%" border="0" cellspacing="4" cellpadding="2" bordercolor="#ffffff">
        ...
        <tr>
            ...
            <td align="center">
                <asp:DropDownList ID="StateList" runat="server" AutoPostBack="True" DataSource="<%# StateProvincesSet %>"
                    ...
                    ondatabound="StateList_DataBound">
                </asp:DropDownList>
            </td>
           
            <td align="center">
                <asp:DropDownList ID="CityList" runat="server" AutoPostBack="True"
                    DataTextField="City" DataValueField="ID" DataTextFormatString="{0}"
                    OnSelectedIndexChanged="CityList_SelectedIndexChanged" 
                    ondatabound="CityList_DataBound">
                </asp:DropDownList>
            </td>
            <td align="center">
                <asp:DropDownList ID="CountyList" runat="server" AutoPostBack="True"
                    DataTextField="County" DataValueField="id"
                    OnSelectedIndexChanged="CountyList_SelectedIndexChanged" 
                     ondatabound="CountyList_DataBound">
                </asp:DropDownList>
            </td>
             <td align="center">
                 <asp:DropDownList ID="CountyCityList" runat="server"
                    DataTextField="city" DataValueField="id" DataTextFormatString="{0}" 
                     ondatabound="CountyCityList_DataBound">
                </asp:DropDownList>
             </td>
        </tr>
        <tr>
            ...
            <td align="center">
                <asp:TextBox ID="CountyName" runat="server" />
            </td>
            <td align="center">
                <asp:Button ID="btnCountyCityRem" runat="server" Text="Remove Assoc." 
                    onclick="btnCountyCityRem_Click" />
            </td>
        </tr>
        <tr>
            <td align="center">
            ...
            <td align="center">
             ...
             <td align="center">
                <asp:Button ID="CountyRename" runat="server" Text="Rename" CausesValidation="False"
                    OnClick="CountyRename_Click" />
            </td>
            <td align="center">
            <asp:TextBox ID="txtCouCtyRename" runat="server" />
            </td>
        </tr>
        <tr>
            <td align="center">
            ...
            <td align="center">
                <asp:Button ID="CountyDelete" runat="server" Text="Delete" CausesValidation="False"
                    OnClick="CountyDelete_Click"
                     onclientclick="return confirm('You sure you want to delete item?');" />
            </td>
            <td align="center">
            <asp:Button ID="btnCity" runat="server" Text="Rename" CausesValidation="False" 
        ...
        <tr>
            ...
            <td align="center">
                <asp:DropDownList ID="CityList2" runat="server" AutoPostBack="True" DataSource="<%# CitiesSet %>"
                    DataMember="Cities" DataTextField="City" DataValueField="ID" 
                    DataTextFormatString="{0}" 
                    onselectedindexchanged="CityList2_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
            <td align="center">
            <asp:Button ID="btnCouCtyDelete" runat="server" Text="Delete" 
                    CausesValidation="False" onclick="btnCouCtyDelete_Click" 
                    onclientclick="return confirm('You sure you want to delete item?');" />
            </td>
        </tr>
        <tr>
            ...
            <td align="center">
             ...
             <td align="center">
                <asp:TextBox ID="NewCounty" runat="server" />
                <br />
                <%--<asp:RequiredFieldValidator ID="EnterCounty" runat="server" ErrorMessage="Please enter county name"
                    ControlToValidate="NewCounty" Display="Dynamic" />--%>
                <asp:RegularExpressionValidator ID="InvalidCounty" runat="server" Display="Dynamic"
                    ControlToValidate="NewCounty" ErrorMessage="Invalid county name entered"
                    ValidationExpression="^[a-zA-Z0-9\-]([a-zA-Z0-9\- ]){1,50}[a-zA-Z0-9\-]$" />
            </td>
            <td align="center">
            
                                  <asp:TextBox ID="txtCouCtyAdd" runat="server" MaxLength="200"></asp:TextBox>
        ...
        <tr>
            ...
            <td align="center">
             ...
             <td align="center">
                <asp:Button ID="CountyAdd" runat="server" Text="Add" CausesValidation="False" 
                    onclick="CountyAdd_Click">
                </asp:Button>
            </td>
            <td align="center">
            
            <asp:Button ID="btnCityCouAdd" runat="server" Text="Add" CausesValidation="False" 
                    onclick="btnCityCouAdd_Click">
                </asp:Button>
        ...
        <tr>
            ...
            <td align="center">
                <asp:TextBox ID="Country_Title_OverRide" runat="server" MaxLength="200"></asp:TextBox>
            </td>
            <td align="center">
                <asp:TextBox ID="State_Title_override" runat="server" MaxLength="200"></asp:TextBox>
            </td>
           
            <td align="center">
                <asp:TextBox ID="City_Title_Override" runat="server" MaxLength="200"></asp:TextBox>
            </td>
             <td align="center">
                <asp:TextBox ID="County_Title_override" runat="server" MaxLength="200"></asp:TextBox>
            </td>
            <td align="center">
                <asp:TextBox ID="txtCouCity_Title" runat="server" MaxLength="200"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="center">
            ...
            <td align="center">
                <asp:Button ID="BtnChangeCountryTitle" runat="server" CausesValidation="False" Text="Change Country Title"
                    OnClick="BtnChangeCountryTitle_Click" />
            </td>
            <td align="center">
                <asp:Button ID="BtnChangeStateTitle" runat="server" CausesValidation="False" Text="Change State Title"
                    OnClick="BtnChangeStateTitle_Click" />
            </td>
            
            <td align="center">
                <asp:Button ID="BtnChangeCityTitle" runat="server" OnClick="BtnChangeCityTitle_Click"
                    CausesValidation="False" Text="Change City Title" />
            </td>
            <td align="center">
                <asp:Button ID="BtnChangeCountyTitle" runat="server" CausesValidation="False" 
                    Text="Change County Title" onclick="BtnChangeCountyTitle_Click"/>
            </td>
            <td>
             <asp:Button ID="btnChangeCouCtyTitle" runat="server"
                    CausesValidation="False" Text="Change City Title" 
                                onclick="btnChangeCouCtyTitle_Click" />
        ...
        <tr>
            ...
            <td align="center">
                <asp:TextBox ID="Country_description_override" runat="server" MaxLength="300" TextMode="MultiLine"
                    ToolTip="Enter the meta tag descriptoin text.  Note you are limited to 254 characters"></asp:TextBox>
            </td>
            <td align="center">
            ...
            <td align="center">
             ...
             <td align="center">
                <asp:TextBox ID="County_Description_override" runat="server" MaxLength="254" TextMode="MultiLine"
                    ToolTip="Enter the meta tag descriptoin text.  Note you are limited to 254 characters"></asp:TextBox>
            </td>
            <td>
            <asp:TextBox ID="txtChangeCouCtyDesc" runat="server" MaxLength="254" TextMode="MultiLine"
                    ToolTip="Enter the meta tag description text.  Note you are limited to 254 characters"></asp:TextBox>
        ...
        <tr>
            ...
            <td align="center">
                <asp:Button ID="BtnChangeCountryDescription" runat="server" CausesValidation="False"
                    OnClick="BtnChangeCountryDescription_Click" Text="Change Description" />
            </td>
            <td align="center">
                <asp:Button ID="BtnChangeStateDescription" runat="server" CausesValidation="False"
                    OnClick="BtnChangeStateDescription_Click" Text="Change Description" ToolTip="Press here to change the State Decription Metatag" />
            </td>
            
            <td align="center">
                <asp:Button ID="BtnChangeCityDescription" runat="server" CausesValidation="False"
                    OnClick="BtnChangeCityDescription_Click" Text="Change Description" ToolTip="Click here to change the CITY description meta tag" />
            </td>
            <td align="center">
                <asp:Button ID="BtnChangeCountyDescription" runat="server" 
                    CausesValidation="False" Text="Change Description" 
                    ToolTip="Click here to change the County description meta tag" 
                    onclick="BtnChangeCountyDescription_Click" />
            </td>
            <td align="center">
              <asp:Button ID="btnCouCtyChangeDesc" runat="server" CausesValidation="False"
                    Text="Change Description" ToolTip="Click here to change the CITY description meta tag" 
                                onclick="btnCouCtyChangeDesc_Click" />
            </td>
        </tr>
    </table>
