        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                <form id="resp_form" class="formborder" runat="server">
                    <div class="row">
                        <div id="headertitle" class="col-md-6">Property #xxxx in City, State</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3"> <asp:TextBox ID="cancel90" CssClass="normalval" ClientIDMode="Static" runat="server"></asp:TextBox></div>
                    </div>
                    <div class="row">
                        <div class="col-md-3"><label class="normaltxt">60 days prior to arrival</label></div>
                        <div class="col-md-3"> <asp:TextBox ID="cancel60" CssClass="normalval" ClientIDMode="Static" runat="server"></asp:TextBox></div>
                    </div>
                    <div class="row">
                        <div class="col-md-3"><label class="normaltxt">30 days prior to arrival</label></div>
                        <div class="col-md-3"> <asp:TextBox ID="cancel30" CssClass="normalval" ClientIDMode="Static" runat="server"></asp:TextBox></div>
                    </div>
